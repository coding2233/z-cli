package("llama.cpp")
    ...
    add_versions("6002", "9dc0e34057dc55a3c0c63758d4ba473b5657977f1d5560e8bc8c222193bf580c")
    add_versions("6001", "b0ae912f29bf8308f2d9aa42c627c7c61401eb743727bc47e682144b35b0f025")
    ...
    on_install(function (package)
        ...
        table.insert(configs, "-DGGML_OPENBLAS=" .. (package:config("blas") == "openblas" and "ON" or "OFF"))
